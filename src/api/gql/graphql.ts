...
export type GetWorkEmailsStatusQuery = { workEmails: Array<{ id: string, isValidated: boolean, status: EmailStatus, workEmail: string }>, salaries: Array<{ id: string }>, workRoles: Array<{ description: string | null, id: string, name: string, seniorities: Array<{ id: string, name: string, description: string | null }> }> };
