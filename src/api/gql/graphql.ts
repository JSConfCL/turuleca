...
export type GetWorkEmailsStatusQuery = { workEmails: Array<{ ' $fragmentRefs'?: { 'WorkEmailFragment': WorkEmailFragment } }>, salaries: Array<{ id: string }>, workRoles: Array<{ description: string | null, id: string, name: string, seniorities: Array<{ id: string, name: string, description: string | null }> }> };
...
export const WorkEmailFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"WorkEmail"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ValidatedWorkEmail"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"isValidated"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"workEmail"}},{"kind":"Field","name":{"kind":"Name","value":"confirmationDate"}}]}}]} as unknown as DocumentNode<WorkEmailFragment, unknown>;
